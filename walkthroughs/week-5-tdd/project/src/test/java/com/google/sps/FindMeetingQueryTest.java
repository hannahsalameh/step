...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalMandatoryAttendeeMix(){
      Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void lastEndIsntLastStart(){
      // Have one person, but have their last event that end not be the same as the last event that starts
    //
    // Events  :       |----A-------|
    //                     |--A--|
    // Day     : |---------------------|
  ...
  public void justEnoughRoomOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. Theres an optional person, but it would interferre, so they are not included.
    //
    // Events  : |--A--||--C--||----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void justEnoughRoomAllOptional() {
    //Person A is optional to attend. There is just enough space for them to attend.
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
